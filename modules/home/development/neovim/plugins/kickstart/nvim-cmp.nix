    ...
    plugins = {
      ...
      cmp = {
        ...
        settings = {
          ...
          # WARNING: If plugins.cmp.autoEnableSources Nixivm will automatically
          # enable the corresponding source plugins. This will work only when
          # this option is set to a list. If you use a raw lua string, you will
          # need to explicitly enable the relevant source plugins in your nixvim
          # configuration.
          sources = [
            {
              name = "lazydev";
